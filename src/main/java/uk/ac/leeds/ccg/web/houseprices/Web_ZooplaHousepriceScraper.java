...
import uk.ac.leeds.ccg.web.io.Web_XMLDOMReader;
...
public class Web_ZooplaHousepriceScraper extends Web_Scraper {
    ...
    protected final UKPC_Checker pcc;
    ...
    public static void main(String[] args) throws Exception {
        try {
            if (args.length == 0) {
                ...
                args[0] = "C:/Users/geoagdt/data/web/zoopla/";
                //args[1] = "r";
                args[1] = "";
            }
            // Test run 1
...
//        args[2] = "SW9";
    ...
    public void run(String[] args) {
        try {
            ...
            url = url1;
            Path outcodesFile = Paths.get(directory.toString(), "outcodes.xml");
            //init_Outcodes(outcodesFile);
            outcodes = new TreeSet<>();
            outcodes.add("ls7");
            if (args.length == 2) {
...
//        sharedLogPW.flush();
    ...
    /**
     * 
     * @param fpp completeFirstPartPostcode
     * @param url
     * @return 
     */
    public boolean isReturningOutcode(String fpp,
            String url) {
        if (outcodes.contains(fpp)) {
            try {
                HttpURLConnection connection = getOpenHttpURLConnection(url);
...
//        // Tests on 2019/11/26 reveal that there is a need now to use https 
//        // and parse the data in a completely different way!!!
//        aURLString = "https://www.zoopla.co.uk/house-prices/ls7-2eu/";
