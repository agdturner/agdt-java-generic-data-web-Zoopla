...
//        }
    ...
    protected void initialiseOutputs(int type, String filenamepart) throws IOException {
        Path outDir = Paths.get(zooplaHousepriceScraper.getDirectory().toString(), "" + type);
        Files.createDirectories(outDir);
        outFile = Paths.get(outDir.toString(), filenamepart + ".csv");
        logFile = Paths.get(outDir.toString(), filenamepart + ".log");
    ...
    protected String[] getPostcodeForRestart(int type, String filenamepart)
        ...
        String line;
        try (BufferedReader br = Generic_IO.getBufferedReader(logFile)) {
